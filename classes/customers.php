...
class ShopgateAddress extends ShopgateContainer {
	...
	public function getIsInvoiceAddress() {
		return (bool)$this->is_invoice_address;
	}
	...
	public function getIsDeliveryAddress() {
		return (bool)$this->is_delivery_address;
	}
	...
	public function getAddressType() {
		return (int)(($this->getIsInvoiceAddress() ? self::INVOICE : 0) | ($this->getIsDeliveryAddress() ? self::DELIVERY : 0));
	}
